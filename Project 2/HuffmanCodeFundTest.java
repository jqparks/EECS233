...
public class HuffmanCodeFundTest {
	...
	public void testCodeMethod() {
    	...
    	assertTrue(
			"skeleton: This method returns the code of specific byte.",
			true);
	}
	...
	public void testToStringMethod() {
    	...
    	assertTrue(
			"skeleton: This method returns a string containing the table of the binary encodings of each byte in the Huffman Code.",
			true);
	}
}
